...
const PACKAGE_VERSION = '1.4.0'; // TODO: How to get this from package.json with modules
...
class Range {
  ...
  updateUserProfile(userId, profile, params = {}) {
    return this._put(`users/${userId}/profile`, { profile }, params);
  }
  updateUserState(userId, state, params = {}) {
  ...
  eventAnalysis(userId, query = {}, params = {}) {
